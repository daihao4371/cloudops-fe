<template>
  ...
  >
    ...
    <a-col :span="24">
      ...
      <a-card title="k8s集群表单字段" :bordered=true :headStyle="{color:'#1271d4',fontSize: 20}"
              :bodyStyle="{padding:'0'}">
...
async function handleSubmit() {
  try {
    ...
    // TODO custom api
    var modFunc = createK8sCluster
    if (unref(isUpdate)) {
      modFunc = updateK8sCluster
    }
    // 发起请求
    // 判断一下menus的类型
    ...
    console.log("k8s集群操作要发起请求了 reqData", reqData)
